...
func TestValidCodeSigningChain(t *testing.T) {
	...
	if err := ValidateCodeSigningCertChain(certChain); err != nil {
		t.Fatal(err)
	}
}
...
func TestValidTimeStampingChain(t *testing.T) {
	...
	if err := ValidateTimeStampingCertChain(certChain); err != nil {
		t.Fatal(err)
	}
}
...
func TestFailEmptyChain(t *testing.T) {
	...
	err := ValidateCodeSigningCertChain(certChain)
...
func TestFailInvalidPathLen(t *testing.T) {
	...
	err := ValidateCodeSigningCertChain(certChain)
	assertErrorEqual("expected path length of 1 but certificate has path length 0 instead", err, t)
}
...
func TestFailInvalidPathLenCa(t *testing.T) {
	...
	assertErrorEqual("expected path length of 3 but certificate has path length 2 instead", err, t)
}
...
func TestFailNoBasicConstraintsCa(t *testing.T) {
	...
	assertErrorEqual("ca field in basic constraints must be present, critical, and set to true", err, t)
}
...
func TestFailKuNotCriticalCertSignCa(t *testing.T) {
	...
	assertErrorEqual("key usage extension must be marked critical", err, t)
}
...
func TestFailKuMissingCa(t *testing.T) {
	...
	assertErrorEqual("key usage extension must be present", err, t)
}
...
func TestFailKuNotCertSignCa(t *testing.T) {
	...
	assertErrorEqual("key usage must have the bit positions for key cert sign set", err, t)
}
...
func TestFailCaTrueLeaf(t *testing.T) {
	...
	assertErrorEqual("if the basic constraints extension is present, the ca field must be set to false", err, t)
}
...
func TestFailKuNoDigitalSignatureLeaf(t *testing.T) {
	...
	assertErrorEqual("key usage must have the bit positions for digital signature set", err, t)
}
...
func TestFailKuWrongValuesLeaf(t *testing.T) {
	...
	assertErrorEqual("key usage must not have the bit positions for key cert sign or crl sign set", err, t)
}
...
func TestFailRsaKeyTooSmallLeaf(t *testing.T) {
	...
	assertErrorEqual("rsa public key length must be 2048 bits or higher", err, t)
}
...
func TestFailEcdsaKeyTooSmallLeaf(t *testing.T) {
	...
	assertErrorEqual("ecdsa public key length must be 256 bits or higher", err, t)
}
...
func TestFailEkuWrongValuesCodeLeaf(t *testing.T) {
	...
	assertErrorEqual("extended key usage must not contain ServerAuth eku", err, t)
}
...
func TestFailEkuMissingCodeSigningLeaf(t *testing.T) {
	...
	assertErrorEqual("extended key usage must contain CodeSigning eku", err, t)
}
...
func TestFailEkuMissingTimeStampingLeaf(t *testing.T) {
	...
	assertErrorEqual("extended key usage must contain TimeStamping eku", err, t)
}
